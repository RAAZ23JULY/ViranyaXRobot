...
PM_START_TEXT = """ 
*Hᴇʟʟᴏ {} * [!](https://te.legra.ph/file/5cf279dec990cf07f4b57.jpg)
───────────────────────
...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(text="🏡Oғғɪᴄᴇ🏡", url=f"https://t.me/xentrixbots"),
    ],
    [
        InlineKeyboardButton(text="🌿Oᴡɴᴇʀ🌿", url=f"https://t.me/Epicstarr"),
    ],
]
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="📍𝐎𝐖𝐍𝐄𝐑📍", url=f"https://t.me/Epicstarr"
                        ),
                        InlineKeyboardButton(
                            text="🎄𝐑𝐄𝐏𝐎🎄", 
                            url="https://t.me/Epicstarr",
                        ),
                    ],
                    [
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != {OWNER_ID} and DONATION_LINK:
            update.effective_message.reply_text(
                f"» ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴩᴇʀ ᴏғ {dispatcher.bot.first_name} sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ɪs [𝚅𝙸𝚁𝙰𝙽𝚈𝙰](https://t.me/Epicstarr)"
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendAnimation(
                f"@{SUPPORT_CHAT}",
                animation="https://te.legra.ph/file/5cf279dec990cf07f4b57.jpg",
                caption=f"""
{dispatcher.bot.first_name}
╔═════ஜ۩۞۩ஜ═════╗

♨️𝗠𝗔𝗗𝗘 𝗕𝗬 [𝗩𝗜𝗟𝗟𝗔𝗜𝗡](https://t.me/Epicstarr)♨️
